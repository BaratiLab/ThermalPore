...
class Model(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.dpt_head_conv_2 = nn.Conv3d(dim // 2, 32, kernel_size = 3, stride = 1, padding = 1)
        ...
        self.dpt_head_conv_4 = nn.Conv2d(num_frame_patches * 4, out_channels=out_channels, kernel_size = 3, stride = 1, padding = 1)
